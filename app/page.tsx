   ...
   {/* Buttons section */}
    ...
    <main className="mt-24 mx-5 lg:mx-56">
      <div className=" bg-linear-[190deg,black_50%,orange_70%,cyan_80%,teal] flex flex-col text-center items-center justify-center  px-20 py-48 border-1 border-slate-50/10 space-y-7 ">
        ...
        <p className="text-lg lg:text-xl text-stone-400 font-normal max-w-xl">Vercel provides the developer tools and cloud infrastructure to build, scale, and secure a faster, more personalized web.</p>
        <div className="*:text-sm *:lg:text-md *:rounded-full flex space-x-8 *:font-medium">
