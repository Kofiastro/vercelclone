...
<rect width="1.331719" height="39.2062" transform="matrix(0 -1 -1 0 39.8922 18.7044)" fill="#D9D9D9"/>
      ...
      <h1 className="text-xl lg:text-3xl font-semibold items-center inline-block ">Develop with your favorite tools <span className="inline-block align-middle size-6"><Terminal/>
       ...
       {/* container 2  */}
        <div className="grid grid-row-1 relative md:grid-cols-2  md:divide-x md:divide-y-0  divide-y divide-slate-50/10 border-1 border-slate-50/10 ">
       {/* First Column */}
        ...
        <div className="space-x-1  ">
         ...
         <li>Delta compression using up to 12 threads</li>
         <li>Compressing objects: 100% (4/4), done.</li>
         <li> Writing objects: 100% (4/4), 412 bytes | 412.00 KiB/s, done.</li>
         </ul>
          ...
          <div>
            ...
            <div className=" p-5 border-1 border-gray-50/10 ">
          <h1  className=" text-lg md:text-2xl font-medium text-gray-50 bg-clip-text rounded-md ">What will you ship ?</h1>
          <div className=" flex items-center justify-center"><IoTriangleSharp className="size-20 md:size-10 opacity-20"/></div>
            </div>
          </div>
